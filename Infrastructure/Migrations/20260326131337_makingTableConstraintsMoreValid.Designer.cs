...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260326131337_makingTableConstraintsMoreValid")]
    partial class makingTableConstraintsMoreValid
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Cart", b =>
                {
                    b.HasOne("Domain.Entities.Profile", "Profile")
                        .WithOne("Cart")
                        .HasForeignKey("Domain.Entities.Cart", "ProfileId")
            ...
            modelBuilder.Entity("Domain.Entities.Wishlist", b =>
                {
                    b.HasOne("Domain.Entities.Profile", "Profile")
                        .WithOne("Wishlist")
                        .HasForeignKey("Domain.Entities.Wishlist", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
